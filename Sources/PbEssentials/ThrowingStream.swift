...
/**
 A synchronous sequence generated from an error-throwing closure partialy
 compatible with AsyncThrowingStream but for synchronous environment.
...
{
    private let produce : () throws -> Element?
